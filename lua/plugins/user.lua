return {
  ...
  },
  {
    ...
    config = function()
      ...
      function set_keybinds(_client, bufnr)
      ...
      lspconfig.jdtls.setup(vim.tbl_deep_extend("force", default_config, {
        root_dir = lspconfig.util.root_pattern(".classpath", "pom.xml", "gradlew", ".git"),
      }))
      initialized["jdtls"] = true

      mason_lspconfig.setup_handlers {
        function(server_name)
          -- if not lspconfig[server_name] then
          if not initialized[server_name] then lspconfig[server_name].setup(default_config) end
        end,
      }
    end,
  },
